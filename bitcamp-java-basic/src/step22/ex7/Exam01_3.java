...
import step22.ex7.ByteArrayDataInputStream;
...
public class Exam01_3 {
    public static void main(String[] args) throws Exception {
        ...
        // 바이트 배열에서 데이터를 읽는 도구
        ByteArrayDataInputStream bytein = new ByteArrayDataInputStream(buf);
        
        // FileInputStream에 붙여서 사용햇던 DataInputStream을 이번엔 바이트어레이쪽에 붙이기
