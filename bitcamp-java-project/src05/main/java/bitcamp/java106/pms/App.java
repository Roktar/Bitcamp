...
// ver 0.5 - member/add, list, view 명령어를 처리하는 코드를 메소드로 분리한다.
// ver 0.4 - team/add, list, view 명령어를 처리하는 코드를 메소드로 분리한다
// ver 0.3 - help 명령어를 처리하는 코드를 메소드로 분리한다
// ver 0.2 - quit 명령어를 처리하는 코드를 메소드로 분리한다
// ver 0.1 - 명령 입력 프롬프트를 메소드로 분리한다
public class App {
