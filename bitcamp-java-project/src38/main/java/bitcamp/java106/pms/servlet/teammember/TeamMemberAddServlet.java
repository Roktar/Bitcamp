...
public class TeamMemberAddServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        this.memberDao = InitServlet.getAppCtx().getBean(MemberDao.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.printf("<meta http-equiv='Refresh' content='1;url=../view?name=%s'>", URLEncoder.encode(teamName, "UTF-8"));
