...
public class TaskAddServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        taskDao = InitServlet.getAppCtx().getBean(TaskDao.class);
        teamMemberDao = InitServlet.getAppCtx().getBean(TeamMemberDao.class);
    }
    ...
    protected void doGet(
        ...
        try {
            ...
            out.println("<head>");
            out.println("<meta charset='UTF-8'>");
            out.printf("<meta http-equiv='Refresh' content='3;url=list?teamName=%s'>", teamName);
            out.println("<title>작업 등록</title>");
            out.println("</head>");
            out.println("<body>");
            out.printf("<h1>'%s' 팀의 작업 등록</h1>\n", teamName);
