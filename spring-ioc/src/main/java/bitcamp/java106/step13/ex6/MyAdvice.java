...
public class MyAdvice {
    ...
    @AfterReturning(pointcut="execution(* bitcamp.java106.step13.ex6.X.*(..))", returning="returnValue")
    public void doAfterReturning(Object returnValue) {
        System.out.println("MyAdvice.doAfterReturning() : " + returnValue);
    }
    // 예외발생 시 예외객체 받기
    @AfterThrowing(pointcut="execution(* bitcamp.java106.step13.ex6.X.*(..))", throwing="error")
